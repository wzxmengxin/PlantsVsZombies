...
BEGIN_MESSAGE_MAP(CMFCApplication2Dlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON1, &CMFCApplication2Dlg::OnBnClickedCourse)
	ON_BN_CLICKED(IDC_CHECK1, &CMFCApplication2Dlg::OnBnClickedCheck1)
	ON_BN_CLICKED(IDC_CHECK2, &CMFCApplication2Dlg::OnBnClickedCheck2)
END_MESSAGE_MAP()
...
void CMFCApplication2Dlg::OnBnClickedCourse() {
	CString str;
	int age = 10;
